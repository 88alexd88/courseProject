...
if name == "Alex" || name == "Eileen"
	...
	if designation == "male" || designation == "m"
		...
		puts "You should consider a name change. Maybe to Eileen. It's a beautiful name."
	end
...
bottles = 99
	...
	puts "0 bottles of beer on the wall 0 bottles of beer. They looked around and had a big frown because there are 0 bottle of beer on the wall."
